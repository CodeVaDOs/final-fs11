            ...
            >
                ...
                <Grid className={classes.subGrid} item xs={8}>
                    ...
                    <Box style={{marginTop: "8px", marginBottom: "0px"}}>
                        <ButtonStyle btnState={dataForm.typeClient} w={"100px"} h={"30px"} ml={"25px"} fw="400"
                                     fs="14px" text={t('client')} onClick={toggle}/>
                        <ButtonStyle btnState={dataForm.typeManager} w={"100px"} h={"30px"} ml={"56px"} fw="400"
                                     fs="14px" text={t('manager')} onClick={toggle}/>
                    </Box>
                    <Box>
